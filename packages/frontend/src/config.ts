...
export const config = {
  ...
  contracts: {
    ...
    perpEngine: env(
      ...
      "CDK7LFB334FDFEB5VHFAPTDJGDMTAVXTJQDCCHC2SUMEYLR7ZDQEYYYZ",
    ),
    funding: env(
    ...
    risk: env(
      ...
      "CBL3YLKRHLSNIHGRACTXRDXIYKWA7CAANE3TA7YJUVQTLWHSI7KKADCF",
    ),
    structured: env(
    ...
    slpVault: env(
      ...
      "CATD6NCR3DB2FWAH4NGAJURYWOOSS6YTGD62SQRA42YARTI36TNZFTW4",
    ),
    /**
